...
See the [TA-lib indicators](https://github.com/askmike/gekko/blob/stable/docs/strategies/talib_indicators.md) document for a list of all suppported TA-lib indicators and their required parameters.

See the [Tulip indicators](https://github.com/askmike/gekko/blob/stable/docs/strategies/tulip_indicators.md) document for a list of all supported Tulip indicators and their required parameters.
